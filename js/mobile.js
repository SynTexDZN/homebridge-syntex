    ...
    try
    {
        for(var si in document.styleSheets)
        {
            ...
            if(styleSheet.rules && styleSheet.href)
            {
                ...
                {
                    console.log(styleSheet.rules[ri], styleSheet.rules[ri].selectorText && styleSheet.rules[ri].selectorText.includes(':hover'));
                    ...
                    else if(styleSheet.rules[ri].cssRules)
                    {
                        ...
                        {
                            console.log(styleSheet.rules[ri].cssRules[rj], styleSheet.rules[ri].cssRules[rj].selectorText && styleSheet.rules[ri].cssRules[rj].selectorText.includes(':hover'));
