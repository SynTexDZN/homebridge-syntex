...
module.exports = function(homebridge)
{
    ...
    homebridge.registerAccessory("homebridge-syntex", "SynTexSensor", SynTexWebHookSensorAccessory);
    homebridge.registerAccessory("homebridge-syntex", "SynTexSwitch", SynTexWebHookSwitchAccessory);
};
                    ...
                    if(urlParams.name && urlParams.type && urlParams.mac && urlParams.ip)
                    {
                        config.load('config', (err, obj) => {    
                            ...
                            {                            
                                ...
                                {
                                    if(obj.platforms[i].platform === 'SynTex')
                                    {
                    ...
                    if(urlParams.mac)
                    {
                        ...
                        else
                        {
                            this.storage.load('storage', (err, obj) => {    
                                ...
                                if(obj)
                                {                            
                                    this.log('[Devices2] Storage.json geladen!');
